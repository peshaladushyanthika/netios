;neti OS --- The neti Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE netiOS_VER '1.0.0'	 ;OS version number
	%DEFINE netiOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	mov cx, 1110111b		; Colour: white text on light blue
	...
	os_init_msg		db ' Welcome to neti os ', 0
	os_version_msg		db 'Version ', netiOS_VER, 0

	os_init_msg2		db '                         Hardware Information                         ', 0
	os_version_msg2		db 'Version ', netiOS_VER, 0

	dialog_string_1		db '    welcome you to neti os.      ', 0
	dialog_string_2		db 'select INFO to Hardware Infomation   ', 0
	dialog_string_3		db '      Exit to quit the OS.         ', 0
...
os_draw_background1:
	...
	mov cx, 0101011b		; Colour: white text on light blue
